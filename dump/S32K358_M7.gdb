...
set pagination off
set logging file S32K358_M7.dump
set logging on
...
printf "V/40514284/%08X\n", (*(0x40514284)) # EICHD6_WORD1 @0x284
printf "V/40514288/%08X\n", (*(0x40514288)) # EICHD6_WORD2 @0x288
printf "V/4051428C/%08X\n", (*(0x4051428C)) # EICHD6_WORD3 @0x28C
printf "V/40514290/%08X\n", (*(0x40514290)) # EICHD6_WORD4 @0x290
printf "V/40514294/%08X\n", (*(0x40514294)) # EICHD6_WORD5 @0x294
printf "V/40514298/%08X\n", (*(0x40514298)) # EICHD6_WORD6 @0x298
...
printf "V/4051440C/%08X\n", (*(0x4051440C)) # EICHD12_WORD3 @0x40C
printf "V/40514410/%08X\n", (*(0x40514410)) # EICHD12_WORD4 @0x410
printf "V/40514414/%08X\n", (*(0x40514414)) # EICHD12_WORD5 @0x414
printf "V/40514418/%08X\n", (*(0x40514418)) # EICHD12_WORD6 @0x418
printf "V/40514444/%08X\n", (*(0x40514444)) # EICHD13_WORD1 @0x444
printf "V/40514448/%08X\n", (*(0x40514448)) # EICHD13_WORD2 @0x448
printf "V/4051444C/%08X\n", (*(0x4051444C)) # EICHD13_WORD3 @0x44C
printf "V/40514450/%08X\n", (*(0x40514450)) # EICHD13_WORD4 @0x450
printf "V/40514454/%08X\n", (*(0x40514454)) # EICHD13_WORD5 @0x454
printf "V/40514458/%08X\n", (*(0x40514458)) # EICHD13_WORD6 @0x458
printf "V/40514484/%08X\n", (*(0x40514484)) # EICHD14_WORD1 @0x484
printf "V/40514488/%08X\n", (*(0x40514488)) # EICHD14_WORD2 @0x488
printf "V/4051448C/%08X\n", (*(0x4051448C)) # EICHD14_WORD3 @0x48C
printf "V/40514490/%08X\n", (*(0x40514490)) # EICHD14_WORD4 @0x490
printf "V/40514494/%08X\n", (*(0x40514494)) # EICHD14_WORD5 @0x494
printf "V/40514498/%08X\n", (*(0x40514498)) # EICHD14_WORD6 @0x498
...
printf "V/402E4088/%08X\n", (*(0x402E4088)) # PLLODIV_[2] @0x80 + 2 * 0x4
...
printf "V/402910CC/%08X\n", (*(0x402910CC)) # IMCR419 @0x10CC
printf "V/402910D0/%08X\n", (*(0x402910D0)) # IMCR420 @0x10D0
printf "V/402910D4/%08X\n", (*(0x402910D4)) # IMCR421 @0x10D4
printf "V/402910D8/%08X\n", (*(0x402910D8)) # IMCR422 @0x10D8
printf "V/402910DC/%08X\n", (*(0x402910DC)) # IMCR423 @0x10DC
printf "V/402910E0/%08X\n", (*(0x402910E0)) # IMCR424 @0x10E0
printf "V/402910E4/%08X\n", (*(0x402910E4)) # IMCR425 @0x10E4
printf "V/402910E8/%08X\n", (*(0x402910E8)) # IMCR426 @0x10E8
printf "V/402910EC/%08X\n", (*(0x402910EC)) # IMCR427 @0x10EC
printf "V/402910F0/%08X\n", (*(0x402910F0)) # IMCR428 @0x10F0
printf "V/402910F4/%08X\n", (*(0x402910F4)) # IMCR429 @0x10F4
printf "V/402910F8/%08X\n", (*(0x402910F8)) # IMCR430 @0x10F8
printf "V/402910FC/%08X\n", (*(0x402910FC)) # IMCR431 @0x10FC
printf "V/40291100/%08X\n", (*(0x40291100)) # IMCR432 @0x1100
printf "V/40291104/%08X\n", (*(0x40291104)) # IMCR433 @0x1104
printf "V/40291108/%08X\n", (*(0x40291108)) # IMCR434 @0x1108
printf "V/40291114/%08X\n", (*(0x40291114)) # IMCR437 @0x1114
...
# USDHC @0x404E4000
printf "V/404E4000/%08X\n", (*(0x404E4000)) # DS_ADDR @0
printf "V/404E4004/%08X\n", (*(0x404E4004)) # BLK_ATT @0x4
printf "V/404E4008/%08X\n", (*(0x404E4008)) # CMD_ARG @0x8
printf "V/404E400C/%08X\n", (*(0x404E400C)) # CMD_XFR_TYP @0xC
printf "V/404E4010/%08X\n", (*(0x404E4010)) # CMD_RSP0 @0x10
printf "V/404E4014/%08X\n", (*(0x404E4014)) # CMD_RSP1 @0x14
printf "V/404E4018/%08X\n", (*(0x404E4018)) # CMD_RSP2 @0x18
printf "V/404E401C/%08X\n", (*(0x404E401C)) # CMD_RSP3 @0x1C
printf "V/404E4020/%08X\n", (*(0x404E4020)) # DATA_BUFF_ACC_PORT @0x20
printf "V/404E4024/%08X\n", (*(0x404E4024)) # PRES_STATE @0x24
printf "V/404E4028/%08X\n", (*(0x404E4028)) # PROT_CTRL @0x28
printf "V/404E402C/%08X\n", (*(0x404E402C)) # SYS_CTRL @0x2C
printf "V/404E4030/%08X\n", (*(0x404E4030)) # INT_STATUS @0x30
printf "V/404E4034/%08X\n", (*(0x404E4034)) # INT_STATUS_EN @0x34
printf "V/404E4038/%08X\n", (*(0x404E4038)) # INT_SIGNAL_EN @0x38
printf "V/404E403C/%08X\n", (*(0x404E403C)) # AUTOCMD12_ERR_STATUS @0x3C
printf "V/404E4040/%08X\n", (*(0x404E4040)) # HOST_CTRL_CAP @0x40
printf "V/404E4044/%08X\n", (*(0x404E4044)) # WTMK_LVL @0x44
printf "V/404E4048/%08X\n", (*(0x404E4048)) # MIX_CTRL @0x48
printf "V/404E4050/%08X\n", (*(0x404E4050)) # FORCE_EVENT @0x50
printf "V/404E4054/%08X\n", (*(0x404E4054)) # ADMA_ERR_STATUS @0x54
printf "V/404E4058/%08X\n", (*(0x404E4058)) # ADMA_SYS_ADDR @0x58
printf "V/404E4060/%08X\n", (*(0x404E4060)) # DLL_CTRL @0x60
printf "V/404E4064/%08X\n", (*(0x404E4064)) # DLL_STATUS @0x64
printf "V/404E40C0/%08X\n", (*(0x404E40C0)) # VEND_SPEC @0xC0
printf "V/404E40C4/%08X\n", (*(0x404E40C4)) # MMC_BOOT @0xC4
printf "V/404E40C8/%08X\n", (*(0x404E40C8)) # VEND_SPEC2 @0xC8
...
printf "V/402A8028/%08X\n", (*(0x402A8028)) # REG_A10 @0x28
printf "V/402A802C/%08X\n", (*(0x402A802C)) # REG_A11 @0x2C
printf "V/402A8030/%08X\n", (*(0x402A8030)) # REG_A12 @0x30
printf "V/402A8034/%08X\n", (*(0x402A8034)) # REG_A13 @0x34
printf "V/402A8038/%08X\n", (*(0x402A8038)) # REG_A14 @0x38
...
printf "V/402A809C/%08X\n", (*(0x402A809C)) # REG_B7 @0x9C
printf "V/402A80A0/%08X\n", (*(0x402A80A0)) # REG_B8 @0xA0
...
printf "V/402A80C0/%08X\n", (*(0x402A80C0)) # REG_B16 @0xC0
printf "V/402A80C8/%08X\n", (*(0x402A80C8)) # REG_B18 @0xC8
printf "V/402A80CC/%08X\n", (*(0x402A80CC)) # REG_B19 @0xCC
printf "V/402A80D0/%08X\n", (*(0x402A80D0)) # REG_B20 @0xD0
...
printf "V/402A80E4/%08X\n", (*(0x402A80E4)) # REG_B25 @0xE4
printf "V/402A80E8/%08X\n", (*(0x402A80E8)) # REG_B26 @0xE8
printf "V/402A80EC/%08X\n", (*(0x402A80EC)) # REG_B27 @0xEC
...
printf "V/40279180/%08X\n", (*(0x40279180)) # PDAC_W0_48 @0x1180
printf "V/40279184/%08X\n", (*(0x40279184)) # PDAC_W1_48 @0x1184
...
printf "V/402799C8/%08X\n", (*(0x402799C8)) # PDAC_W0_313 @0x19C8
printf "V/402799CC/%08X\n", (*(0x402799CC)) # PDAC_W1_313 @0x19CC
