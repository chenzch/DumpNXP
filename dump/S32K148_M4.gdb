...
set $PCC_SAI0 = *(0x40065150)
set $PCC_SAI1 = *(0x40065154)
set $PCC_FlexIO = *(0x40065168)
set $PCC_EWM = *(0x40065184)
set $PCC_LPI2C0 = *(0x40065198)
set $PCC_LPI2C1 = *(0x4006519C)
set $PCC_LPUART0 = *(0x400651A8)
set $PCC_LPUART1 = *(0x400651AC)
set $PCC_LPUART2 = *(0x400651B0)
set $PCC_FTM4 = *(0x400651B8)
set $PCC_FTM5 = *(0x400651BC)
set $PCC_FTM6 = *(0x400651C0)
set $PCC_FTM7 = *(0x400651C4)
set $PCC_CMP0 = *(0x400651CC)
set $PCC_QSPI = *(0x400651D8)
set $PCC_ENET = *(0x400651E4)
