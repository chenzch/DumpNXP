...
set pagination off
set logging file S32K144W_M4.dump
set logging on
...
# IMASK2 @0x24
printf "V/40025024/%08X\n", (*(0x40025024))
# IMASK1 @0x28
printf "V/40025028/%08X\n", (*(0x40025028))
# IFLAG2 @0x2C
printf "V/4002502C/%08X\n", (*(0x4002502C))
# IFLAG1 @0x30
...
# RXIMR[32] @0x880 + 32 * 0x4
printf "V/40025900/%08X\n", (*(0x40025900))
# RXIMR[33] @0x880 + 33 * 0x4
printf "V/40025904/%08X\n", (*(0x40025904))
# RXIMR[34] @0x880 + 34 * 0x4
printf "V/40025908/%08X\n", (*(0x40025908))
# RXIMR[35] @0x880 + 35 * 0x4
printf "V/4002590C/%08X\n", (*(0x4002590C))
# RXIMR[36] @0x880 + 36 * 0x4
printf "V/40025910/%08X\n", (*(0x40025910))
# RXIMR[37] @0x880 + 37 * 0x4
printf "V/40025914/%08X\n", (*(0x40025914))
# RXIMR[38] @0x880 + 38 * 0x4
printf "V/40025918/%08X\n", (*(0x40025918))
# RXIMR[39] @0x880 + 39 * 0x4
printf "V/4002591C/%08X\n", (*(0x4002591C))
# RXIMR[40] @0x880 + 40 * 0x4
printf "V/40025920/%08X\n", (*(0x40025920))
# RXIMR[41] @0x880 + 41 * 0x4
printf "V/40025924/%08X\n", (*(0x40025924))
# RXIMR[42] @0x880 + 42 * 0x4
printf "V/40025928/%08X\n", (*(0x40025928))
# RXIMR[43] @0x880 + 43 * 0x4
printf "V/4002592C/%08X\n", (*(0x4002592C))
# RXIMR[44] @0x880 + 44 * 0x4
printf "V/40025930/%08X\n", (*(0x40025930))
# RXIMR[45] @0x880 + 45 * 0x4
printf "V/40025934/%08X\n", (*(0x40025934))
# RXIMR[46] @0x880 + 46 * 0x4
printf "V/40025938/%08X\n", (*(0x40025938))
# RXIMR[47] @0x880 + 47 * 0x4
printf "V/4002593C/%08X\n", (*(0x4002593C))
# RXIMR[48] @0x880 + 48 * 0x4
printf "V/40025940/%08X\n", (*(0x40025940))
# RXIMR[49] @0x880 + 49 * 0x4
printf "V/40025944/%08X\n", (*(0x40025944))
# RXIMR[50] @0x880 + 50 * 0x4
printf "V/40025948/%08X\n", (*(0x40025948))
# RXIMR[51] @0x880 + 51 * 0x4
printf "V/4002594C/%08X\n", (*(0x4002594C))
# RXIMR[52] @0x880 + 52 * 0x4
printf "V/40025950/%08X\n", (*(0x40025950))
# RXIMR[53] @0x880 + 53 * 0x4
printf "V/40025954/%08X\n", (*(0x40025954))
# RXIMR[54] @0x880 + 54 * 0x4
printf "V/40025958/%08X\n", (*(0x40025958))
# RXIMR[55] @0x880 + 55 * 0x4
printf "V/4002595C/%08X\n", (*(0x4002595C))
# RXIMR[56] @0x880 + 56 * 0x4
printf "V/40025960/%08X\n", (*(0x40025960))
# RXIMR[57] @0x880 + 57 * 0x4
printf "V/40025964/%08X\n", (*(0x40025964))
# RXIMR[58] @0x880 + 58 * 0x4
printf "V/40025968/%08X\n", (*(0x40025968))
# RXIMR[59] @0x880 + 59 * 0x4
printf "V/4002596C/%08X\n", (*(0x4002596C))
# RXIMR[60] @0x880 + 60 * 0x4
printf "V/40025970/%08X\n", (*(0x40025970))
# RXIMR[61] @0x880 + 61 * 0x4
printf "V/40025974/%08X\n", (*(0x40025974))
# RXIMR[62] @0x880 + 62 * 0x4
printf "V/40025978/%08X\n", (*(0x40025978))
# RXIMR[63] @0x880 + 63 * 0x4
printf "V/4002597C/%08X\n", (*(0x4002597C))
# FDCTRL @0xC00
